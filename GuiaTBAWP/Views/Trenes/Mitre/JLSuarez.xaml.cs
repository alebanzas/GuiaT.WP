...
{
    public partial class JLSuarez : PhoneApplicationPage
    {
        public JLSuarez()
        {
            InitializeComponent();
            ...
            StatusChecker.Check("Trenes.JLSuarez");
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            FillViewModel();
            _dataRealTimeService = new TrenRealTimeStatusService(20, "mitre-r-l")
            {
                EndRequest = model =>
                {
