...
namespace GuiaTBAWP.Views.Trenes
{
    public partial class Mitre : PhoneApplicationPage
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            FillViewModel();
            _dataRealTimeService = new TrenRealTimeStatusService(20, "mitre-r-t")
            {
                EndRequest = model =>
                {
        ...
        private void FillRealTimeModel(LiveTrenModel model)
        {
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                ...
                TEV_15_1.Text = estaciones[15].Ida1 == 0 ? "andén" : string.Format("{0} min", estaciones[15].Ida1);
                TEV_15_2.Text = estaciones[15].Ida2 == 0 ? "andén" : string.Format("{0} min", estaciones[15].Ida2);
                ...
                TEV_16_3.Text = estaciones[16].Vuelta1 == 0 ? "andén" : string.Format("{0} min", estaciones[16].Vuelta1);
                TEV_16_4.Text = estaciones[16].Vuelta2 == 0 ? "andén" : string.Format("{0} min", estaciones[16].Vuelta2);
            });
        }
